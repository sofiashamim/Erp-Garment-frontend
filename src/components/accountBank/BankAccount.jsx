  ...
  <div  style={{display:"flex"}} class="card-body">
   ...
   <h5> Withdraw</h5></div>
    ...
    alignItems: "baseline"}} id='groupBtn' class="btn-group" role="group" aria-label="Basic outlined example">
     <button type="button" class="btn btn-outline-primary"  ><Link to="/admin">+Add New bank</Link></button>
     <button type="button" class="btn btn-outline-primary"><Link to="/newAdmin">Deposit/Withdraw</Link></button>
